...
export const metadata: Metadata = {
  ...
  description: `A philosophical-mapping tool. 16 dimensions, ten archetypes, ${PHILOSOPHERS.length} thinkers. Take the quiz, see where your worldview sits — and which thinkers across history have stood near you.`,
};
    ...
    '@graph': [
      {
        ...
        description: `A philosophical-mapping tool. 16 dimensions, ten archetypes, ${PHILOSOPHERS.length} thinkers.`,
      },
      {
        '@type': 'WebSite',
  ...
  return (
    <>
      ...
      <main className="relative z-10 min-h-[100svh] bg-cream text-ink">
            ...
            <div className="relative">
              ...
              >
                <span
                  ...
                  style={{ textShadow: '6px 6px 0 var(--pixel-shadow, var(--color-acc))' }}
                >
                  MULL
                </span>
              </h1>
              ...
              <p className="mt-5 max-w-[640px] text-[13.5px] leading-[1.55] text-acc-deep">
                ...
                <Link
                  ...
                  className="text-ink-soft underline decoration-acc/40 underline-offset-3 hover:decoration-acc-deep"
                >
              ...
              <div className="mt-6 flex items-center gap-3 lg:hidden">
                <PhilosopherSprite name="Diogenes" archetypeKey="hammer" size={64} floating />
                <span
                  className="text-[10px] tracking-[0.18em] text-acc-deep"
                  style={{ fontFamily: 'var(--font-pixel-display)' }}
                >
                  ▸ {t('home.one_of_560_l1', locale, { count: PHILOSOPHERS.length })}
                  <br />
                  {t('home.one_of_560_l2', locale)}
                </span>
              </div>
            </div>
        ...
        <ScrollReveal
          as="section"
          className="border-y-4 border-ink bg-[#FFFCF4] px-6 py-14 sm:px-10 sm:py-20"
        >
          <div className="mx-auto max-w-[1200px]">
        ...
        <ScrollReveal
          as="section"
          className="mx-auto max-w-[1200px] border-t-4 border-ink px-6 py-20 sm:px-10 sm:py-24"
        >
          <div
            className="flex items-center gap-3 text-[10px] tracking-[0.24em] text-acc-deep"
            style={{ fontFamily: 'var(--font-pixel-display)' }}
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4 text-[12px] text-acc-deep">
            ...
            <Link href="/wrapped" className="py-1.5 hover:text-ink">
              {t('home.also_wrapped', locale)}
            </Link>
            <span>·</span>
            <Link href="/classes" className="py-1.5 hover:text-ink">
              {t('home.also_classes', locale)}
            </Link>
            <span>·</span>
            <Link href="/install" className="py-1.5 hover:text-ink">
              {t('home.add_home', locale)}
            </Link>
            <span>·</span>
            <Link href="/about" className="py-1.5 hover:text-ink">
              {t('home.also_about', locale)}
            </Link>
            <span>·</span>
            <Link href="/methodology" className="py-1.5 hover:text-ink">
        ...
        <ScrollReveal
          as="section"
          className="mx-auto max-w-[1200px] border-t-4 border-ink px-6 py-20 sm:px-10 sm:py-28"
        >
        ...
        <ScrollReveal
          as="section"
          className="mx-auto max-w-[920px] px-6 pb-28 pt-12 text-center sm:px-10"
        >
        ...
        <footer className="border-t-4 border-ink bg-ink px-6 py-5 sm:px-10">
          <div className="mx-auto flex max-w-[1200px] flex-wrap items-baseline justify-between gap-4 text-[14px] leading-relaxed text-acc">
            ...
            <nav className="flex flex-wrap gap-5 text-acc-soft">
              <Link href="/about" className="py-1.5 hover:text-acc">
                {t('nav.about', locale)}
              </Link>
              <Link href="/topic" className="py-1.5 hover:text-acc">
                {t('nav.topics', locale)}
              </Link>
              <Link href="/vs" className="py-1.5 hover:text-acc">
                {t('nav.matchups', locale)}
              </Link>
              <Link href="/install" className="py-1.5 hover:text-acc">
                {t('home.add_home', locale)}
              </Link>
              <Link href="/methodology" className="py-1.5 hover:text-acc">
                {t('nav.methodology', locale)}
              </Link>
              <Link href="/privacy" className="py-1.5 hover:text-acc">
                {t('home.footer_privacy', locale)}
              </Link>
              <Link href="/terms" className="py-1.5 hover:text-acc">
                {t('home.footer_terms', locale)}
              </Link>
...
function SmallSurface({ href, label, body }: { href: string; label: string; body: string }) {
  return (
    <Link
      href={href}
    ...
    >
      <div className="text-[14px] font-medium text-ink" style={{ fontFamily: 'var(--font-prose)' }}>
        {label}
      </div>
