...
function pickSplittingFeatured(
  ...
  const ranked = rankSplittingPairs(
    userVec,
    candidates,
    (c) => c.vA,
    (c) => c.vB,
  ...
  return (
    <main className="mx-auto max-w-[920px] px-5 pb-32 pt-10 sm:px-10">
              ...
              <li key={p.href}>
                ...
                >
                  ...
                  >
                    {p.name1}{' '}
                    <span
                      style={{ color: 'var(--color-acc-deep)', fontFamily: pixel, fontSize: 10 }}
                    >
                      {t('vs.vs_badge', locale)}
                    </span>{' '}
                    {p.name2}
      ...
      >
        ...
        >
          {t('vs.construct_body_pre', locale, { n: PHILOSOPHERS.length })}
          <code style={{ fontFamily: pixel, fontSize: 12, color: 'var(--color-acc-deep)' }}>
            /vs/[slug-a]/[slug-b]
          </code>
          {t('vs.construct_body_post', locale)}
        </p>
        <Link
          href="/philosopher"
          style={{
