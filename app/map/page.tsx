    ...
    <main className="mx-auto max-w-[1400px] px-4 pb-32 pt-10 sm:px-8 sm:pt-14">
      ...
      <section className="mt-12 grid gap-8 md:grid-cols-2">
        ...
        >
          ...
          >
            <li>
              <strong>{t('map.read1_lead', locale)}</strong>
              {t('map.read1_rest', locale)}
            </li>
            <li>
              <strong>{t('map.read2_lead', locale)}</strong>
              {t('map.read2_rest', locale)}
            </li>
            <li>
              <strong>{t('map.read3a_lead', locale)}</strong>
              {t('map.read3a_rest', locale)}
              <strong>{t('map.read3b_lead', locale)}</strong>
              {t('map.read3b_rest', locale)}
            </li>
            <li>{t('map.read4', locale)}</li>
          </ul>
        </div>
