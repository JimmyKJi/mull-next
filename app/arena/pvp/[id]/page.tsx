...
export default async function PvpMatchPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const canParticipate = iAmChallenger || iAmOpponent || session.status === 'pending_opponent'; // anyone can view + accept open
