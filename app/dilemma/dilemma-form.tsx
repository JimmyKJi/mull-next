    ...
    return (
      ...
      >
        ...
        {result.analysis ? (
          ...
          >
            Your response was saved. The AI analyzer isn't connected yet — when it is, past
            responses will be re-analyzed.
          </p>
        ) : null}
    ...
    >
      ...
      >
        ...
        >
          ...
          {charCount}/4000
          {tooShort
            ? ' · ' + t('dilemma.too_short', locale)
            : charCount > 3700
              ? ' · ' + t('dilemma.approaching_limit', locale)
              : ''}
        </span>
        <button
          type="submit"
      ...
      >
        ...
        <span>
          <strong style={{ color: 'var(--color-ink)' }}>
            {t('dilemma.show_on_public', locale)}
          </strong>{' '}
          <span style={{ fontStyle: locale === 'en' ? 'normal' : 'italic' }}>
            Your most recent 5 public dilemma responses appear at{' '}
