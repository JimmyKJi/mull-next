    ...
    <main style={{
      ...
      <Section title="The principles">
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'grid', gap: 14 }}>
          ...
          <Promise title='Not an "AI app".'>AI is used in a few specific, bounded places — turning your written daily dilemma, diary entry, or exercise reflection into a small dimensional shift on your map; generating the back-and-forth in simulated philosopher debates; and (Mull+) writing your end-of-year retrospective from your own data. The 16-dimensional model, the archetype system, the philosopher positions, the figures, the quiz questions — all hand-designed by humans who care about getting philosophy right. The full list, with prompts and data flows, is on the <Link href="/methodology" style={{ color: '#8C6520', textDecoration: 'underline', textUnderlineOffset: 3 }}>methodology page</Link>.</Promise>
