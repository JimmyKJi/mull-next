    ...
    <>
      ...
      >
        ...
        <div className="mt-8 space-y-8">
          ...
          {/* ─── Quotes ─── */}
          <PixelWindow
            title={t('arch_detail.section_quotes', locale).toUpperCase()}
            badge="▶ QUOTES"
          >
            <ul className="space-y-3">
              {archetype.quotes.map((q, i) => (
                ...
                >
                  ...
                  <p className="mt-1 text-[12px] tracking-wide text-acc-deep">— {q.attribution}</p>
                </li>
              ))}
            </ul>
          </PixelWindow>
          ...
          {/* ─── Reading list ─── */}
          <PixelWindow
            title={t('arch_detail.section_reading', locale).toUpperCase()}
            badge="▶ READING"
          >
            <p
            ...
            <ul className="space-y-3">
              {archetype.readingList.map((book, i) => (
                ...
                >
                  ...
                  <p className="mt-2 text-[14px] leading-[1.55] text-ink-soft">{book.note}</p>
                </li>
              ))}
            </ul>
          </PixelWindow>
          ...
          {/* ─── Kindred thinkers ─── */}
          <PixelWindow
            title={t('arch_detail.section_kindred', locale).toUpperCase()}
            badge="▶ KINDRED"
          >
            <p
              ...
              {archetype.kindredThinkers.map((thinker, i) => {
                const matched = PHILOSOPHERS.find(
                  (p) =>
                    ...
                    p.aliases.some((al) => al.toLowerCase() === thinker.toLowerCase()),
                );
                const chipClass =
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            <PixelWindow
              title={t('arch_detail.section_get_right', locale).toUpperCase()}
              badge="▶ STRENGTH"
            >
              <p
            ...
            <PixelWindow
              title={t('arch_detail.section_falter', locale).toUpperCase()}
              badge="▶ LIMIT"
            >
              <p
                className="text-[15px] leading-[1.65] text-ink"
          ...
          {archetype.commonMistakes.length > 0 ? (
            <PixelWindow
              title={t('arch_detail.section_mistakes', locale).toUpperCase()}
              badge="▶ FAILURE MODES"
            >
              <p
                className="mb-4 text-[14px] leading-[1.6] text-ink-soft"
          ...
          {archetype.modernExemplars.length > 0 ? (
            <PixelWindow
              title={t('arch_detail.section_exemplars', locale).toUpperCase()}
              badge="▶ LIVING"
            >
              <p
                className="mb-4 text-[14px] leading-[1.6] text-ink-soft"
          ...
          {/* ─── A day in the life ─── */}
          <PixelWindow
            title={t('arch_detail.section_dayinlife', locale).toUpperCase()}
            badge="▶ SCENE"
          >
            <p
          ...
          {/* ─── Dominant dimensions ─── */}
          <PixelWindow
            title={t('arch_detail.section_dimensions', locale).toUpperCase()}
            badge="▶ DIMS"
          >
            <p
              className="mb-4 text-[14px] leading-[1.6] text-ink-soft"
              ...
              {dimensions.map((d, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-1.5 text-[13.5px] leading-[1.55] text-ink-soft">{dimDesc}</p>
                  </li>
                );
              })}
            </ul>
          ...
          {exerciseObjs.length > 0 ? (
            <PixelWindow
              title={t('arch_detail.section_exercises', locale).toUpperCase()}
              badge="▶ PRACTICE"
            >
              <p
                className="mb-4 text-[14px] leading-[1.6] text-ink-soft"
          ...
          {(() => {
            ...
            return (
              <PixelWindow
                title={t('arch_detail.section_topics', locale).toUpperCase()}
                badge="▶ QUESTIONS"
              >
                <p
                  className="mb-4 text-[14px] leading-[1.6] text-ink-soft"
          ...
          {archetype.tensions.length > 0 ? (
            <PixelWindow
              title={t('arch_detail.section_tensions', locale).toUpperCase()}
              badge="▶ FRICTIONS"
            >
              <p
                className="mb-4 text-[14px] leading-[1.6] text-ink-soft"
          ...
          {/* ─── Other archetypes ─── */}
          <PixelWindow
            title={t('arch_detail.section_other', locale).toUpperCase()}
            badge="▶ EXPLORE"
          >
            <p
              className="mb-4 text-[14px] leading-[1.6] text-ink-soft"
