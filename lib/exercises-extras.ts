...
export const EXERCISE_EXTRAS: Record<string, ExerciseExtras> = {
  ...
  premortem: {
    ...
    relatedThinkers: [
      {
        name: 'Seneca',
        note: 'Letters 91 and 99 are the classical sources for premeditatio malorum.',
      },
      { name: 'Marcus Aurelius', note: 'Meditations II.1 — begin each day expecting friction.' },
      {
        name: 'Gary Klein',
        note: "Modern formalization in 'Performing a Project Premortem' (Harvard Business Review, 2007).",
      },
      {
        name: 'Daniel Kahneman',
        note: 'Thinking, Fast and Slow recommends the technique as a corrective to planning-fallacy optimism.',
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Gary Klein',
        year: '1998',
        note: "Klein's foundational work on naturalistic decision-making, including the cognitive logic that became the premortem.",
      },
      {
        title: 'Letters from a Stoic',
        author: 'Seneca',
        note: 'Letter 91 is the key one for this practice.',
      },
      {
        title: 'Thinking, Fast and Slow',
        author: 'Daniel Kahneman',
        year: '2011',
        note: 'Chapter 23 on the planning fallacy is the empirical case for why premortems work.',
      },
    ],
    relatedExercises: ['negative-visualization', 'anticipating-objections'],
    kindredPractices: [
      {
        name: 'Pre-mortem letter to your future self',
        note: 'A long-form variant — write a full letter from six-month-future-you describing the failure.',
      },
      {
        name: 'Red-teaming',
        note: 'An institutional cousin — a designated team is tasked with attacking the plan.',
      },
    ],
  },
  ...
  'negative-visualization': {
    ...
    relatedThinkers: [
      {
        name: 'Epictetus',
        note: "Discourses III.24: 'When you kiss your child, say to yourself, perhaps tomorrow you will kiss a corpse.'",
      },
      { name: 'Marcus Aurelius', note: 'Meditations IX.30 — picture a thing about to be lost.' },
      {
        name: 'William Irvine',
        note: 'A Guide to the Good Life rebuilds Stoic practice around this exercise specifically.',
      },
    ],
    furtherReading: [
      {
        ...
        year: '2008',
        note: 'The clearest modern reconstruction; Irvine treats negative visualization as the central Stoic practice.',
      },
      {
        title: 'Meditations',
        author: 'Marcus Aurelius',
        year: 'c. 170 CE',
        note: 'Books II and IX have the densest concentration of these exercises in their original form.',
      },
    ],
    relatedExercises: ['memento-mori', 'examen', 'view-from-above'],
    kindredPractices: [
      {
        name: 'Tibetan death meditation',
        note: "Buddhist parallels — visualizing one's own dying as preparation for a clearer life.",
      },
      {
        name: 'Tonglen',
        note: 'A different Buddhist practice: take in suffering, give out relief — not the same shape, but in the same family.',
      },
    ],
  },
  ...
  'socratic-self-questioning': {
    ...
    relatedThinkers: [
      {
        name: 'Socrates',
        note: "The original — preserved in Plato's early dialogues (Apology, Crito, Euthyphro).",
      },
      {
        name: 'Pierre Hadot',
        note: 'Made the case that ancient philosophy was primarily exercises of this kind, not abstract theory.',
      },
      {
        name: 'Iris Murdoch',
        note: 'Modern Platonist who treats moral attention as a related skill.',
      },
    ],
    furtherReading: [
      {
        title: 'Plato: Apology, Crito, Euthyphro',
        author: 'Plato',
        year: 'c. 399 BCE',
        note: 'Three short dialogues — the Socratic method in its native form.',
      },
      {
        title: 'What Is Ancient Philosophy?',
        author: 'Pierre Hadot',
        year: '1995',
        note: 'The argument that the ancients practiced philosophy as a way of life, not as theory.',
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Five whys',
        note: "Toyota's industrial cousin — used for diagnosing manufacturing problems by repeated 'why' questions.",
      },
    ],
  },
    ...
    relatedThinkers: [
      {
        ...
        note: 'Meditations VII.48 and IX.30 are the two clearest versions of the practice.',
      },
      {
        name: 'Pierre Hadot',
        note: "His essay 'The View from Above' is the modern study of the practice's history.",
      },
      {
        name: 'Frank White',
        note: "Coined 'overview effect' to describe what astronauts report — the structurally identical experience from space.",
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Pierre Hadot',
        year: '1992',
        note: 'The best book on Marcus Aurelius and the philosophical exercises of his Meditations.',
      },
      {
        title: 'The Overview Effect',
        author: 'Frank White',
        year: '1987',
        note: 'The original astronaut interviews — strange, moving documentation of a parallel practice.',
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: 'Buddhist cousin — radiating attention outward in concentric circles.',
      },
      {
        name: 'Cosmic perspective grounding',
        note: 'Sometimes used in CBT as a defusion technique.',
      },
    ],
  },
  ...
  examen: {
    ...
    relatedThinkers: [
      {
        ...
        note: 'Spiritual Exercises (1548) — the Examen is part of the broader month-long retreat program.',
      },
      {
        name: 'Karl Rahner',
        note: '20th-century Jesuit who reframed the Examen for modern consciousness.',
      },
      {
        name: 'James Martin',
        note: "Contemporary Jesuit whose 'The Jesuit Guide to (Almost) Everything' has the cleanest plain-English account.",
      },
    ],
    furtherReading: [
      {
        ...
        author: 'James Martin',
        year: '2010',
        note: 'The Examen explained for non-religious readers without losing its substance.',
      },
      {
        title: 'Spiritual Exercises',
        author: 'Ignatius of Loyola',
        year: '1548',
        note: 'The original. Dense, theological, but the Examen is in part 1 if you want to read just that.',
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Morning pages',
        note: "Julia Cameron's longer-form journaling cousin — fewer rules, similar daily-noticing function.",
      },
      {
        name: 'Naikan',
        note: 'Japanese Buddhist practice with an interestingly inverted structure — what did I receive, what did I give, what trouble did I cause.',
      },
    ],
  },
  ...
  'memento-mori': {
    ...
    relatedThinkers: [
      {
        name: 'Marcus Aurelius',
        note: 'Meditations II.11 and IV.17 are about choosing well in light of mortality.',
      },
      {
        name: 'Seneca',
        note: 'On the Shortness of Life is the great Stoic essay on time and finitude.',
      },
      {
        name: 'Heidegger',
        note: 'Being and Time argues that authentic life requires Being-toward-death — a 20th-century reformulation of the same intuition.',
      },
      {
        name: 'Atul Gawande',
        note: 'Being Mortal brings the practice into contemporary medical context.',
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Seneca',
        year: 'c. 49 CE',
        note: 'Forty pages on time, mortality, and how we waste our hours. Indispensable.',
      },
      {
        title: 'Being Mortal',
        author: 'Atul Gawande',
        year: '2014',
        note: 'What modern medicine has gotten wrong about the end of life — and the kind of memento-mori medicine ought to teach.',
      },
      {
        title: 'Four Thousand Weeks',
        author: 'Oliver Burkeman',
        year: '2021',
        note: 'Modern productivity-cult critique built around the finitude of a life.',
      },
    ],
    relatedExercises: ['negative-visualization', 'view-from-above', 'examen'],
    kindredPractices: [
      {
        name: 'Death meditation (maranasati)',
        note: "Buddhist practice; the Theravada tradition has detailed instructions on contemplating the body's decomposition.",
      },
      {
        name: 'Letter to mourners',
        note: "Write what you'd want said about you when you're not there. Read it once a year.",
      },
    ],
  },
  ...
  'fallacy-hunt': {
    ...
    relatedThinkers: [
      {
        name: 'Aristotle',
        note: 'Sophistical Refutations is the founding catalog of fallacious moves.',
      },
      {
        name: 'Arthur Schopenhauer',
        note: 'The Art of Being Right is grimly funny — the dishonest moves systematized.',
      },
      {
        name: 'Carl Sagan',
        note: "The Demon-Haunted World's 'baloney detection kit' is the modern lay-reader's version.",
      },
      {
        name: 'Bo Bennett',
        note: 'Compiled the most extensive contemporary online catalog (logicallyfallacious.com).',
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Carl Sagan',
        year: '1995',
        note: 'Chapter 12 has the baloney detection kit — accessible, charming, lasting.',
      },
      {
        title: 'Asking the Right Questions',
        author: 'Browne & Keeley',
        note: 'A standard critical-thinking textbook — drier than Sagan but more thorough.',
      },
    ],
    relatedExercises: ['steelmanning', 'counterexample-drill', 'argument-map'],
    kindredPractices: [
      {
        name: 'Daily news-reading with margin notes',
        note: 'Mark every appeal-to-fear, false dichotomy, and unsupported claim. Two weeks of this changes how you read.',
      },
    ],
  },
  ...
  steelmanning: {
    ...
    relatedThinkers: [
      {
        name: 'Daniel Dennett',
        note: 'Intuition Pumps codifies steelmanning as a tool, attributing the underlying logic to Anatol Rapoport.',
      },
      {
        name: 'Anatol Rapoport',
        note: 'Game theorist whose rules for productive disagreement underlie the practice.',
      },
      {
        name: 'John Stuart Mill',
        note: 'On Liberty Ch. 2 makes the case that holding a view without engaging its best opponent leaves the view itself shallow.',
      },
    ],
    furtherReading: [
      {
        ...
        year: '2013',
        note: 'The contemporary toolkit; steelmanning sits alongside other moves of the same family.',
      },
      {
        title: 'On Liberty',
        author: 'John Stuart Mill',
        year: '1859',
        note: 'Chapter 2 is the classical defense of why we need to take opponents seriously.',
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: "Bryan Caplan's variant — write the opposing view convincingly enough to be mistaken for an actual believer.",
      },
    ],
  },
  ...
  'counterexample-drill': {
    ...
    relatedThinkers: [
      {
        name: 'Philippa Foot',
        note: 'Originator of the trolley problem — counterexample as ethical instrument, weaponized.',
      },
      {
        name: 'Judith Jarvis Thomson',
        note: "'Killing, Letting Die, and the Trolley Problem' (1976) is the modern fountainhead.",
      },
      {
        name: 'Edmund Gettier',
        note: 'His 1963 three-page paper on knowledge is the most famous single counterexample in philosophy.',
      },
    ],
    furtherReading: [
      {
        ...
        author: 'W.D. Ross',
        year: '1930',
        note: 'An entire ethical system designed to survive the counterexamples of utilitarianism and Kantianism.',
      },
      {
        title: "Justice: What's the Right Thing to Do?",
        author: 'Michael Sandel',
        year: '2009',
        note: 'An accessible book-length tour through ethical principles via counterexamples.',
      },
    ],
    relatedExercises: ['reductio', 'fallacy-hunt', 'socratic-self-questioning'],
    kindredPractices: [
      {
        name: 'Trolley problem rounds',
        note: 'Run a chain of trolley variants on yourself. Notice where your intuitions flip and try to articulate why.',
      },
    ],
  },
  ...
  'argument-map': {
    ...
    relatedThinkers: [
      {
        ...
        note: 'His model of argument — claim, data, warrant, backing — is the most influential modern framework.',
      },
      {
        name: 'Monroe Beardsley',
        note: 'His 1950 textbook Practical Logic gave argument mapping a popular form.',
      },
      {
        name: 'Tim van Gelder',
        note: 'Modern proponent; built tools and ran studies on how mapping changes reasoning.',
      },
    ],
    furtherReading: [
      {
        ...
        year: '1958',
        note: 'The Toulmin model — slightly dry but foundational.',
      },
      {
        title: 'Critical Thinking: An Introduction',
        author: 'Alec Fisher',
        note: 'Modern textbook with extensive mapping exercises.',
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Mind mapping',
        note: "A non-argumentative cousin — useful for ideation but doesn't enforce inferential structure.",
      },
    ],
  },
  ...
  reductio: {
    ...
    relatedThinkers: [
      {
        name: 'Zeno of Elea',
        note: 'The arrow and Achilles paradoxes are reductios on the standard understanding of motion.',
      },
      {
        name: 'Plato',
        note: 'Used reductio extensively in the dialogues, especially the Parmenides.',
      },
      {
        name: 'Bertrand Russell',
        note: "Russell's paradox is a reductio that broke naive set theory.",
      },
    ],
    furtherReading: [
      {
        ...
        year: '2002',
        note: 'An accessible catalog of philosophical paradoxes — many of which are reductios on common-sense positions.',
      },
      {
        title: "Russell's autobiography",
        author: 'Bertrand Russell',
        note: "Russell's account of what it felt like to discover the paradox that broke Frege's life work — applied reductio at its most consequential.",
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: 'The mathematical formalization — assume the opposite, derive a contradiction, conclude the original.',
      },
    ],
  },
  ...
  'sixty-second-case': {
    ...
    relatedThinkers: [
      ...
      {
        name: 'George Orwell',
        note: "'Politics and the English Language' is the modern manifesto for cutting flab.",
      },
      {
        name: 'William Strunk Jr.',
        note: "Strunk and White's 'omit needless words' — the same instinct, in the prose register.",
      },
    ],
    furtherReading: [
      {
        ...
        year: '1976',
        note: 'About prose, but the underlying discipline of compression carries directly to argument.',
      },
      {
        title: 'Politics and the English Language',
        author: 'George Orwell',
        year: '1946',
        note: 'The essay, not a book — read in twenty minutes, useful for life.',
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Elevator pitch',
        note: 'The startup-world cousin — same compression skill, different content.',
      },
    ],
  },
  ...
  'anticipating-objections': {
    ...
    relatedThinkers: [
      {
        name: 'Thomas Aquinas',
        note: "The Summa Theologiae's structure is the canonical exemplar of objection-first writing.",
      },
      {
        name: 'Peter Abelard',
        note: 'Sic et Non (Yes and No) collected contradictory authoritative quotations to train students in dialectical thinking.',
      },
      {
        name: 'John Stuart Mill',
        note: "On Liberty Ch. 2 is one long argument that you don't actually understand your view until you can rebut its strongest opponent.",
      },
    ],
    furtherReading: [
      {
        title: 'Selections from the Summa Theologiae',
        author: 'Thomas Aquinas',
        note: 'Read a few articles in the videtur-sed contra-respondeo structure to feel how the medieval objection-first method worked.',
      },
      {
        title: 'On Liberty',
        author: 'John Stuart Mill',
        year: '1859',
        note: "Mill's argument that opposing views are necessary even for the truth-holder is the modern defense of the practice.",
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: 'An institutional cousin — formally assigning someone to argue the opposing view in deliberation.',
      },
    ],
  },
    ...
    relatedThinkers: [
      {
        ...
        note: 'His undergraduate physics lectures are the modern monument to this discipline.',
      },
      {
        name: 'George Orwell',
        note: "'Politics and the English Language' is the ethical version — clear prose as a moral act.",
      },
      {
        name: 'Mortimer Adler',
        note: "'How to Read a Book' includes a parallel exercise on the receiving end: explaining a book back to demonstrate you read it.",
      },
    ],
    furtherReading: [
      {
        ...
        year: '1985',
        note: "The popular memoir; doesn't teach the technique directly, but the spirit is everywhere.",
      },
      {
        title: 'Politics and the English Language',
        author: 'George Orwell',
        year: '1946',
        note: 'Six rules for clear writing that double as rules for clear thinking.',
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: 'The Reddit subgenre — same discipline, more casual.',
      },
      {
        name: 'Teaching back',
        note: 'A pedagogical cousin — students explain a concept to peers as a check on their own understanding.',
      },
    ],
  },
  ...
  'dialectical-loop': {
    ...
    relatedThinkers: [
      {
        name: 'G.W.F. Hegel',
        note: 'The Phenomenology of Spirit is the source — extremely difficult; read with a guide.',
      },
      {
        name: 'Karl Marx',
        note: "Adapted Hegel's dialectic to history; the Communist Manifesto is the most accessible application.",
      },
      {
        name: 'Theodor Adorno',
        note: "Negative Dialectics is the 20th-century rethinking — the synthesis isn't always available.",
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Peter Singer',
        year: '1983',
        note: 'The cleanest entry point to Hegel for first-time readers.',
      },
      {
        title: 'Reading Capital Politically',
        author: 'Harry Cleaver',
        year: '1979',
        note: 'How dialectical thinking works in a contemporary political reading.',
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: "Edward de Bono's heuristic — wear different perspectives sequentially. Less rigorous than dialectic but in the same family.",
      },
    ],
  },
  ...
  'switch-sides': {
    ...
    relatedThinkers: [
      {
        name: 'Protagoras',
        note: "The original — 'on every matter there are two opposing arguments.'",
      },
      {
        name: 'Cicero',
        note: 'Trained students to argue both sides as the central skill of education.',
      },
    ...
    furtherReading: [
      {
        ...
        author: 'John Stuart Mill',
        year: '1859',
        note: "Chapter 2 in particular — Mill's defense of why opposing views must be honestly engaged.",
      },
      {
        title: 'The Sophists',
        author: 'G.B. Kerferd',
        year: '1981',
        note: "A scholarly recovery of the sophists from Plato's dismissal — including Protagoras's actual position.",
      },
    ],
    ...
    kindredPractices: [
      {
        name: "Devil's advocate",
        note: 'Lighter version — argue the opposing view once, not iteratively.',
      },
      {
        name: 'Red team / blue team',
        note: 'Institutional version used in security and policy — formally assign teams to attack and defend a plan.',
      },
    ],
  },
  ...
  'morning-intention': {
    ...
    relatedThinkers: [
      {
        name: 'Marcus Aurelius',
        note: "Meditations II.1 — the morning rehearsal of the day's friction.",
      },
      {
        name: 'Epictetus',
        note: "Enchiridion 1 — begin by sorting what is and isn't within your power.",
      },
      {
        name: 'Pierre Hadot',
        note: "Recovered prosoche (attention) as the central Stoic 'spiritual exercise' in Philosophy as a Way of Life.",
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Marcus Aurelius',
        year: 'c. 170 CE',
        note: 'Book II opens with the canonical morning preparation.',
      },
      {
        title: 'Philosophy as a Way of Life',
        author: 'Pierre Hadot',
        year: '1995',
        note: 'The scholarly case that Stoicism was a set of daily exercises, attention chief among them.',
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Sankalpa',
        note: 'The yogic intention set at the start of practice — a resolve stated in the present tense.',
      },
      {
        name: 'Examen (forward version)',
        note: "The Ignatian review run forward — previewing the day's likely temptations rather than reviewing the past one.",
      },
    ],
  },
  ...
  'three-line-evening': {
    ...
    relatedThinkers: [
      {
        name: 'Seneca',
        note: 'On Anger III.36 — the locus classicus of the nightly self-examination.',
      },
      {
        name: 'Pythagoras',
        note: 'The Golden Verses prescribe a threefold review of the day before sleep.',
      },
      {
        name: 'Ignatius of Loyola',
        note: 'The Examen turned the practice into a structured daily spiritual exercise.',
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Seneca',
        year: 'c. 45 CE',
        note: "Book III, chapter 36 describes Seneca's own nightly accounting in detail.",
      },
      {
        title: 'Letters from a Stoic',
        author: 'Seneca',
        note: 'The Letters return repeatedly to the habit of daily self-reckoning.',
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: 'The fuller Christian version — review the day for where you moved toward or away from your values.',
      },
      {
        name: 'Five-minute journal',
        note: 'A modern structured-prompt journal in the same minimal-dose spirit.',
      },
    ],
  },
  ...
  'loving-kindness': {
    ...
    relatedThinkers: [
      {
        name: 'The Buddha',
        note: 'The Karaniya Metta Sutta (Sutta Nipata 1.8) is the canonical source.',
      },
      {
        name: 'Buddhaghosa',
        note: 'The Visuddhimagga (5th c.) systematized the graded sequence of recipients.',
      },
      {
        name: 'Sharon Salzberg',
        note: 'Did the most to bring metta to a Western lay audience; her Lovingkindness (1995) is the standard guide.',
      },
      {
        name: 'Barbara Fredrickson',
        note: "Psychologist whose studies measured the practice's effect on positive emotion and social connection.",
      },
    ],
    furtherReading: [
      {
        ...
        year: '1995',
        note: 'The accessible modern manual, faithful to the Theravada source.',
      },
      {
        title: 'The Path of Purification (Visuddhimagga)',
        author: 'Buddhaghosa',
        year: 'c. 430 CE',
        note: 'The classical treatment of the brahmaviharas and the order of practice.',
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Tonglen',
        note: "A Tibetan practice in the same family: breathe in another's suffering, breathe out relief.",
      },
      {
        name: 'Compassion cultivation (CCT)',
        note: "Thupten Jinpa's secular protocol, developed at Stanford from the same Buddhist roots.",
      },
    ],
  },
  ...
  'breath-count': {
    ...
    relatedThinkers: [
      {
        name: 'The Buddha',
        note: 'The Anapanasati Sutta is the canonical root of breath-based meditation.',
      },
      {
        name: 'Dogen',
        note: 'The Fukanzazengi (13th c.) frames zazen as goalless sitting, not a means to an end.',
      },
      {
        name: 'Shunryu Suzuki',
        note: "Zen Mind, Beginner's Mind articulates the begin-again attitude the count requires.",
      },
    ],
    furtherReading: [
      {
        ...
        year: '1970',
        note: 'The classic Western introduction to Soto Zen practice and posture.',
      },
      {
        title: 'The Three Pillars of Zen',
        author: 'Philip Kapleau',
        year: '1965',
        note: 'Includes detailed instruction on breath-counting for beginners.',
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Shikantaza',
        note: "'Just sitting' — the count's advanced sibling, which drops the number and rests in bare awareness.",
      },
      {
        name: 'Mantra repetition',
        note: 'A parallel concentration device across traditions: a repeated word in place of a count.',
      },
    ],
  },
  ...
  'mindful-eating': {
    ...
    relatedThinkers: [
      {
        ...
        note: 'The Miracle of Mindfulness — the tangerine as the emblem of eating with full presence.',
      },
      {
        name: 'Jon Kabat-Zinn',
        note: 'Made the raisin exercise the opening practice of the MBSR curriculum.',
      },
      {
        name: 'Jan Chozen Bays',
        note: 'Zen teacher and physician whose Mindful Eating gathered the practice into a full method.',
      },
    ],
    furtherReading: [
      {
        ...
        year: '1975',
        note: 'The source of the tangerine teaching and a gentle introduction to everyday mindfulness.',
      },
      {
        title: 'Mindful Eating',
        author: 'Jan Chozen Bays',
        year: '2009',
        note: 'A practical book-length treatment blending Zen and clinical nutrition.',
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Oryoki',
        note: 'The formal, fully-attentive Zen meal practice, choreographed down to the placement of the bowls.',
      },
      {
        name: 'Saying grace',
        note: 'The pause-and-acknowledge before eating found across traditions — a brief reorientation of attention to the food.',
      },
    ],
  },
  ...
  'letter-future-self': {
    ...
    relatedThinkers: [
      {
        name: 'Marcus Aurelius',
        note: "The Meditations are the great example of philosophical self-address — literally 'to himself.'",
      },
      {
        name: 'Hal Hershfield',
        note: 'Psychologist whose work on future-self continuity explains why vividly picturing your later self changes present behavior.',
      },
      {
        name: 'Derek Parfit',
        note: "Reasons and Persons argues identity over time is a matter of degree — reframing what 'your future self' even is.",
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Derek Parfit',
        year: '1984',
        note: "Part Three on personal identity is the deep background for why writing to a 'future self' is stranger than it looks.",
      },
      {
        title: 'Your Future Self',
        author: 'Hal Hershfield',
        year: '2023',
        note: 'The accessible account of the continuity research and how to act on it.',
      },
    ],
    relatedExercises: ['memento-mori', 'three-line-evening', 'morning-intention'],
    kindredPractices: [
      {
        name: 'FutureMe letters',
        note: 'The online service (since 2002) that emails your letter back to you on a date you set.',
      },
      {
        name: 'Time capsule',
        note: 'The object version of the same impulse — sealing the present away for a later self to open.',
      },
    ],
  },
  ...
  'body-scan': {
    ...
    relatedThinkers: [
      {
        name: 'Jon Kabat-Zinn',
        note: 'Founded MBSR and made the body scan a core clinical mindfulness practice.',
      },
      {
        name: 'S.N. Goenka',
        note: 'Carried the Burmese Vipassana body-sweeping technique (from U Ba Khin) to a worldwide lay audience.',
      },
      {
        name: 'Swami Satyananda',
        note: "Systematized Yoga Nidra's 'rotation of consciousness' through the body.",
      },
    ],
    furtherReading: [
      {
        ...
        year: '1990',
        note: 'The foundational MBSR text, with the body scan as a central practice.',
      },
      {
        title: 'The Art of Living',
        author: 'William Hart',
        year: '1987',
        note: "A clear account of Goenka's Vipassana, including the body-sweeping method.",
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Yoga Nidra',
        note: "A guided 'rotation of consciousness' through the body, done lying down at the edge of sleep.",
      },
      {
        name: 'Progressive muscle relaxation',
        note: "Jacobson's clinical cousin — deliberately tensing and releasing each muscle group in turn.",
      },
    ],
  },
  ...
  'burden-of-proof': {
    ...
    relatedThinkers: [
      {
        name: 'Bertrand Russell',
        note: 'The celestial-teapot analogy (1952) — the burden sits with the one asserting, not the one doubting.',
      },
      {
        name: 'Antony Flew',
        note: "'The Presumption of Atheism' (1976) made burden-of-proof central to a famous philosophical debate.",
      },
      {
        name: 'Carl Sagan',
        note: "'Extraordinary claims require extraordinary evidence' scales the burden to the claim's strangeness.",
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Bertrand Russell',
        year: '1952',
        note: 'The short essay containing the teapot — two pages that fixed the idea in popular thought.',
      },
      {
        title: 'Burden of Proof, Presumption and Argumentation',
        author: 'Douglas Walton',
        year: '2014',
        note: 'The rigorous modern treatment of how burdens actually shift in real argument.',
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: "'What can be asserted without evidence can be dismissed without evidence' — the principle as a one-line blade.",
      },
      {
        name: 'Presumption of innocence',
        note: 'The legal form — the prosecution bears the burden, the accused need prove nothing.',
      },
    ],
  },
  ...
  'necessary-sufficient': {
    ...
    relatedThinkers: [
      {
        name: 'Aristotle',
        note: "His analysis of the four 'causes' (aitia) is the ancient root of thinking carefully about what produces what.",
      },
      {
        name: 'J.L. Mackie',
        note: 'The Cement of the Universe introduced the INUS condition, the precise anatomy of an everyday cause.',
      },
      {
        name: 'David Hume',
        note: "Forced the whole question open by asking what, beyond constant conjunction, we even mean by 'cause.'",
      },
    ],
    furtherReading: [
      {
        ...
        author: 'J.L. Mackie',
        year: '1974',
        note: 'The classic modern analysis of causation and conditions; source of the INUS idea.',
      },
      {
        title: 'A Concise Introduction to Logic',
        author: 'Patrick Hurley',
        note: 'A standard primer that drills the necessary/sufficient distinction with clear exercises.',
      },
    ],
    relatedExercises: ['modus-tollens', 'hidden-premises', 'ockhams-razor'],
    kindredPractices: [
      {
        name: 'Causal diagrams (DAGs)',
        note: 'The modern statistical tool for laying out which conditions actually feed which effects.',
      },
      {
        name: 'Five whys',
        note: 'A diagnostic that, done well, separates the necessary links in a causal chain from the incidental ones.',
      },
    ],
  },
  ...
  'modus-tollens': {
    ...
    relatedThinkers: [
      {
        name: 'Chrysippus',
        note: 'The Stoic logician who catalogued modus tollens among his five basic indemonstrable inferences.',
      },
      {
        name: 'Karl Popper',
        note: 'Built falsificationism on modus tollens — theories advance by surviving attempted refutation.',
      },
      {
        name: 'Duhem & Quine',
        note: 'Showed that a failed prediction indicts the whole web of assumptions, not one theory in isolation.',
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Karl Popper',
        year: '1959',
        note: 'The case that science progresses by falsification — modus tollens as method.',
      },
      {
        title: 'Two Dogmas of Empiricism',
        author: 'W.V.O. Quine',
        year: '1951',
        note: 'The essay behind the holism that complicates any clean falsification.',
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: 'Before holding a belief, ask: what observation would prove it wrong? If nothing could, modus tollens has nothing to grip.',
      },
      {
        name: 'Debugging by elimination',
        note: "The programmer's version — a failing test denies the consequent and sends you hunting the false premise.",
      },
    ],
  },
  ...
  'bayesian-update': {
    ...
    relatedThinkers: [
      {
        name: 'Thomas Bayes',
        note: 'The minister whose 1763 posthumous essay first stated the rule for updating on evidence.',
      },
      {
        name: 'Pierre-Simon Laplace',
        note: 'Rediscovered and generalized the method into a working tool for scientific inference.',
      },
      {
        name: 'Frank Ramsey',
        note: 'Grounded subjective probability with the Dutch-book argument — beliefs must obey the axioms or you can be made to lose for sure.',
      },
    ],
    furtherReading: [
      {
        ...
        year: '2011',
        note: "A readable history of Bayes' rule and its long climb from disrepute to ubiquity.",
      },
      {
        title: 'The Signal and the Noise',
        author: 'Nate Silver',
        year: '2012',
        note: 'An accessible case for Bayesian thinking in forecasting and everyday judgment.',
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: "Philip Tetlock's research on forecasters who win by making many small updates instead of few large ones.",
      },
      {
        name: 'Calibration training',
        note: "Practicing confidence estimates against outcomes so that your '70% sure' is right about 70% of the time.",
      },
    ],
  },
  ...
  'hidden-premises': {
    ...
    relatedThinkers: [
      {
        name: 'Aristotle',
        note: 'Named the enthymeme — the everyday syllogism with a premise left unspoken — in the Rhetoric.',
      },
      {
        name: 'Stephen Toulmin',
        note: "His 'warrant' is the usually-unstated rule licensing the leap from evidence to claim.",
      },
      {
        name: 'Frans van Eemeren',
        note: "Made reconstructing 'unexpressed premises' central to the pragma-dialectical analysis of argument.",
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Stephen Toulmin',
        year: '1958',
        note: 'Introduces the warrant and the anatomy of everyday arguments.',
      },
      {
        title: 'A Rulebook for Arguments',
        author: 'Anthony Weston',
        year: '1986',
        note: 'A short, practical guide that drills the spotting of missing premises.',
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: "Aristotle's own move — restore the suppressed premise and judge the argument whole.",
      },
      {
        name: "'What would have to be true?'",
        note: 'A one-question version: ask what would need to hold for the conclusion to follow, then check whether it does.',
      },
    ],
  },
    ...
    relatedThinkers: [
      {
        ...
        note: 'The 14th-c. Franciscan whose name attached to parsimony, though not to the famous Latin phrasing.',
      },
      {
        name: 'Isaac Newton',
        note: "Made parsimony his first 'Rule of Reasoning in Philosophy' in the Principia.",
      },
      {
        name: 'Albert Einstein',
        note: 'Associated with the qualifier that matters most: as simple as possible, but no simpler.',
      },
    ],
    furtherReading: [
      {
        ...
        year: '2015',
        note: "The definitive modern examination of when parsimony is and isn't a good guide.",
      },
      {
        title: 'The Principia (Rules of Reasoning)',
        author: 'Isaac Newton',
        year: '1687',
        note: "Newton's own statement of the simplicity rule, in his own words.",
      },
    ],
    relatedExercises: ['necessary-sufficient', 'bayesian-update', 'hidden-premises'],
    kindredPractices: [
      {
        ...
        note: 'The statistical formalization — criteria like AIC penalize extra parameters but credit the fit they earn.',
      },
      {
        name: 'KISS principle',
        note: 'The engineering folk-version: keep it simple — fewer parts, fewer failure modes.',
      },
    ],
  },
  ...
  'disjunction-elimination': {
    ...
    relatedThinkers: [
      {
        name: 'Chrysippus',
        note: 'Catalogued the disjunctive syllogism among the Stoic indemonstrables in the 3rd c. BCE.',
      },
      {
        name: 'Arthur Conan Doyle',
        note: 'Gave Holmes the popular formulation — eliminate the impossible, and the remainder, however improbable, is the truth.',
      },
      {
        name: 'John Venn',
        note: "Whose diagrams make vivid the inclusive-vs-exclusive 'or' distinction the rule depends on.",
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Benson Mates',
        year: '1953',
        note: "The scholarly account of Chrysippus's logic and the indemonstrable inference forms.",
      },
      {
        title: 'The Sign of Four',
        author: 'Arthur Conan Doyle',
        year: '1890',
        note: "Where Holmes states the elimination principle that dramatizes the rule's appeal and its hazard.",
      },
    ],
    ...
    kindredPractices: [
      {
        ...
        note: "Medicine's disciplined version — list the possible causes, then test to eliminate, while guarding against the one you forgot to list.",
      },
      {
        name: 'Process of elimination',
        note: 'The everyday cousin — only as reliable as the completeness of the options you started with.',
      },
    ],
  },
    ...
    relatedThinkers: [
      {
        ...
        note: "Made charity a precondition of interpretation itself — you can only understand someone by assuming they're mostly right.",
      },
      {
        name: 'W.V.O. Quine',
        note: 'Word and Object grounds the principle in the practical problem of translating an unfamiliar language.',
      },
    ...
    furtherReading: [
      {
        ...
        year: '1984',
        note: 'The essays where charity becomes a load-bearing part of a theory of meaning.',
      },
      {
        title: 'A Rulebook for Arguments',
        author: 'Anthony Weston',
        year: '1986',
        note: 'Puts the principle to practical, everyday use for ordinary disagreements.',
      },
    ],
    relatedExercises: ['steelmanning', 'ideological-turing-test', 'concession-and-counter'],
    kindredPractices: [
      {
        name: "Rapoport's rules",
        note: "Anatol Rapoport's protocol — restate your target's position so well they thank you, before any criticism.",
      },
      {
        name: 'Active listening',
        note: "The therapeutic cousin — reflect back what you heard until the other person confirms you've got it.",
      },
    ],
  },
  ...
  'concession-and-counter': {
    ...
    relatedThinkers: [
      {
        name: 'Quintilian',
        note: 'The Institutio Oratoria taught concessio — yielding minor points to win the major one.',
      },
      {
        name: 'Aristotle',
        note: 'The Rhetoric anatomizes how establishing goodwill and common ground precedes effective persuasion.',
      },
      {
        name: 'Carl Rogers',
        note: "His client-centered method became the 'Rogerian argument' — understand the other side before advancing your own.",
      },
    ],
    furtherReading: [
      {
        title: 'Rhetoric: Discovery and Change',
        author: 'Young, Becker & Pike',
        year: '1970',
        note: "The text that turned Rogers's therapeutic empathy into a teachable argumentative method.",
      },
      {
        title: 'Rhetoric',
        author: 'Aristotle',
        note: 'The foundational treatment of persuasion, including the role of common ground and goodwill.',
      },
    ],
    relatedExercises: [
      'charitable-interpretation',
    ...
    kindredPractices: [
      {
        ...
        note: "Restate the opposing position to its holder's satisfaction before making your own case.",
      },
      {
        name: "'Yes, and' (improv)",
        note: 'The stage discipline of accepting an offer before building on it — the same move, played for invention.',
      },
    ],
  },
  ...
  'ideological-turing-test': {
    ...
    relatedThinkers: [
      {
        name: 'Bryan Caplan',
        note: "Coined the 'ideological Turing test' in 2011, adapting Turing's imitation game to belief.",
      },
      {
        name: 'Alan Turing',
        note: 'His 1950 imitation game is the original — indistinguishability as the test of a capacity.',
      },
      {
        name: 'John Stuart Mill',
        note: 'On Liberty Ch. 2: knowing only your own side of an argument is barely knowing it at all.',
      },
    ],
    furtherReading: [
      {
        ...
        author: 'John Stuart Mill',
        year: '1859',
        note: 'Chapter 2 is the classical argument for why you must be able to state the other side.',
      },
      {
        title: 'The Scout Mindset',
        author: 'Julia Galef',
        year: '2021',
        note: 'A modern treatment of the habits — including this test — that keep reasoning honest.',
      },
    ],
    ...
    kindredPractices: [
      {
        name: "Devil's advocate",
        note: 'The lighter, looser cousin — argue the other side once, without the bar of fooling a believer.',
      },
      {
        name: 'Red team',
        note: "The institutional form — a group tasked with making the adversary's case as convincingly as possible.",
      },
    ],
  },
  ...
  'reframe-disagreement': {
    ...
    relatedThinkers: [
      {
        name: 'Fisher & Ury',
        note: 'Getting to Yes drew the foundational distinction between positions and underlying interests.',
      },
      {
        name: 'John Gottman',
        note: 'His couples research shows the surface fight is usually a proxy for a deeper, recurring need.',
      },
      {
        name: 'Sue Johnson',
        note: 'Emotionally-focused therapy treats the repeating argument as a signal of an unmet attachment bid.',
      },
    ],
    furtherReading: [
      {
        ...
        year: '1981',
        note: "The negotiation classic; 'focus on interests, not positions' is its central move.",
      },
      {
        title: 'Difficult Conversations',
        author: 'Stone, Patton & Heen',
        year: '1999',
        note: "The Harvard Negotiation Project's guide to finding the real conversation beneath the surface one.",
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Double crux',
        note: "Find the single underlying belief that, if it flipped, would change each side's conclusion — then argue about that.",
      },
      {
        name: 'Interests, not positions',
        note: "The negotiator's habit of asking 'why do they want this?' instead of bargaining over the stated demand.",
      },
    ],
  },
  ...
  'stoic-preview': {
    ...
    relatedThinkers: [
      {
        name: 'Seneca',
        note: "Urged daily premeditatio malorum — rehearse misfortune so it can't ambush you; 'the unexpected blow falls heaviest.'",
      },
      {
        name: 'Epictetus',
        note: 'The Enchiridion advises rehearsing a disturbance, and your intended response, before the event.',
      },
      {
        name: 'Gabriele Oettingen',
        note: "Her 'mental contrasting' research shows that vividly anticipating obstacles improves follow-through.",
      },
    ],
    furtherReading: [
      {
        title: 'Letters from a Stoic',
        author: 'Seneca',
        note: "Letters 91 and 107 lay out the premeditation of misfortune in Seneca's own voice.",
      },
      {
        title: 'Rethinking Positive Thinking',
        author: 'Gabriele Oettingen',
        year: '2014',
        note: 'The empirical case that imagining obstacles beats imagining success.',
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Premortem',
        note: 'The project version of the same logic — imagine the plan has already failed, then trace why.',
      },
      {
        name: 'Mental contrasting (WOOP)',
        note: "Oettingen's protocol: Wish, Outcome, Obstacle, Plan — pair the goal with its likely obstacles.",
      },
    ],
  },
  ...
  'ten-word-version': {
    ...
    relatedThinkers: [
      {
        name: 'Blaise Pascal',
        note: "Source of the 'I would have written a shorter letter if I'd had the time' insight (Lettres Provinciales, 1657).",
      },
      {
        name: 'Strunk & White',
        note: "The Elements of Style distilled the ethic to 'omit needless words.'",
      },
      {
        name: 'Ernest Hemingway',
        note: "His 'iceberg theory' — most of the meaning carried by what's left out — is compression as an aesthetic.",
      },
    ],
    furtherReading: [
      {
        ...
        author: 'Strunk & White',
        year: '1959',
        note: "The slim classic on cutting everything that isn't doing work.",
      },
      {
        title: 'Politics and the English Language',
        author: 'George Orwell',
        year: '1946',
        note: "Orwell's rules for concision and against the padding that hides empty thought.",
      },
    ],
    ...
    kindredPractices: [
      {
        name: 'Elevator pitch',
        note: 'The business version — the whole case in the time between floors.',
      },
      {
        name: 'BLUF (bottom line up front)',
        note: 'The military and email convention of leading with the conclusion, then supporting it.',
      },
    ],
  },
};
