...
export const QUICK_QUESTIONS: Question[] = [
  {
    ...
    a: [
      {
        t: '"There\'s something beyond this. We don\'t know what, but I can feel it."',
        v: v({ MR: 3, TV: 1, CE: 2, SI: 1 }),
      },
      {
        t: '"Everyone faces this. The wisdom is in how we face it."',
        v: v({ AT: 2, PO: 2, TR: 2, TV: 1 }),
      },
      {
        t: '"Tell me what mattered to you. Let\'s name it together."',
        v: v({ SS: 2, VA: 1, CE: 2 }),
      },
      {
        t: '"We made beautiful things. That doesn\'t disappear because you do."',
        v: v({ VA: 2, ES: 1, TD: 1, SS: 1 }),
      },
    ],
  },

  {
    ...
    a: [
      {
        t: "No — some lines you don't cross, even for good outcomes.",
        v: v({ UI: 3, RT: 1, AT: 1 }),
      },
      {
        t: 'Yes — five lives outweigh one. The math is hard but clear.',
        v: v({ TR: 2, UI: 1, PO: 2, WP: 1 }),
      },
      {
        t: 'Yes — and society would be better if we had the courage to do this math openly.',
        v: v({ WP: 2, TR: 2, UI: 2 }),
      },
      {
        t: 'No, but for practical reasons — it would destroy trust in medicine.',
        v: v({ PO: 3, TE: 2, SR: 1 }),
      },
      {
        t: "The question is malformed. Real ethics doesn't reduce to such cases.",
        v: v({ CE: 1, RT: 2, MR: 1, SR: 2 }),
      },
    ],
  },

  {
    ...
    a: [
      ...
      {
        t: 'Find what you actually disagree about underneath the surface.',
        v: v({ TD: 3, SR: 1, TR: 1 }),
      },
      {
        t: 'Decide which of you is more likely right and learn from them.',
        v: v({ SR: 2, RT: 2, TR: 1 }),
      },
      {
        t: "Hold the disagreement. Some things won't resolve.",
        v: v({ MR: 2, AT: 1, SI: 1, TV: 1 }),
      },
...

  {
    ...
    a: [
      {
        t: 'Press it — pleasure is real wherever it comes from.',
        v: v({ ES: 3, VA: 2, TE: 1, SI: 1 }),
      },
      {
        t: "Don't press it — real life has meaning beyond pleasure.",
        v: v({ SS: 2, TV: 2, UI: 1, MR: 1 }),
      },
      {
        t: "Don't press it — what would I be losing if I never knew anything was real?",
        v: v({ TR: 2, SS: 1, SR: 2 }),
      },
      {
        t: 'Press it for some experiences, not all. Curate which truths I want to keep.',
        v: v({ ES: 2, SS: 2, SR: 2, TE: 1 }),
      },
    ],
  },

  {
    ...
    a: [
      {
        t: "They could have chosen differently. They're responsible.",
        v: v({ SS: 3, UI: 1, RT: 1 }),
      },
      {
        t: "Given who they were and what they'd been through, this was always going to happen.",
        v: v({ TR: 1, SI: 2, SR: 1, TV: 2 }),
      },
      {
        t: "Both — they're responsible AND it was always going to happen.",
        v: v({ TR: 1, MR: 2, SR: 1, PO: 1 }),
      },
      {
        t: 'Neither. Life is mostly accidents we narrate after the fact.',
        v: v({ TV: 1, SR: 3, SI: 2 }),
      },
    ],
  },

  {
    ...
    a: [
      ...
      {
        t: "Quit. A meaningful life can't include 40 hours a week of meaninglessness.",
        v: v({ SS: 3, VA: 1, WP: 1 }),
      },
      {
        t: 'Stay, but redefine the work itself. Meaning is a frame you bring.',
        v: v({ SS: 2, WP: 1, PO: 2, TR: 1 }),
      },
      {
        t: 'Stay and grieve quietly. Most lives contain this kind of compromise.',
        v: v({ TV: 3, AT: 1, RT: 1 }),
      },
      {
        t: 'The premise assumes meaning is the right frame for work at all.',
        v: v({ SR: 3, SI: 1, TE: 1 }),
      },
    ],
  },

  {
    ...
    a: [
      ...
      {
        t: 'Stick with tradition. Long survival is evidence of hidden wisdom.',
        v: v({ RT: 3, CE: 1, SR: 1 }),
      },
      {
        t: 'Investigate why the old way persisted before changing anything.',
        v: v({ RT: 2, TE: 2, PO: 2, SR: 1 }),
      },
      { t: 'Try both for a season. Watch what actually happens.', v: v({ TE: 3, PO: 2, SR: 1 }) },
      {
        t: 'Wait. Sometimes the natural way reveals itself when you stop forcing.',
        v: v({ MR: 2, AT: 1, RT: 1, SI: 1 }),
      },
    ],
  },

  {
    ...
    a: [
      {
        t: 'Reading something difficult. Real understanding takes work.',
        v: v({ TD: 3, AT: 2, TR: 2 }),
      },
...

  {
    ...
    a: [
      ...
      {
        t: 'Whichever holds up under serious scrutiny. The kind of skepticism that refines what survives.',
        v: v({ SR: 3, TR: 2, TD: 1 }),
      },
    ],
  },

  {
    ...
    a: [
      ...
      {
        t: "Look for the choice I'm avoiding. That's usually the right one.",
        v: v({ SR: 2, SS: 2, TV: 1 }),
      },
    ],
  },

  {
    ...
    a: [
      ...
      {
        t: 'No god, but the world is sublime enough on its own to deserve reverence.',
        v: v({ VA: 3, ES: 2, SR: 1, MR: 1 }),
      },
      { t: 'The question itself matters more than any answer.', v: v({ TD: 2, SS: 2, MR: 1 }) },
      {
        t: 'Whatever I think personally, I respect what people have built around it.',
        v: v({ CE: 2, RT: 3, PO: 1 }),
      },
    ],
  },

  {
    ...
    a: [
      ...
      {
        t: "No. I'm a different person who shares memories with that one.",
        v: v({ SI: 3, TE: 1, MR: 1 }),
      },
      {
        t: 'The question is malformed — there\'s no fixed "self" to compare.',
        v: v({ SI: 3, MR: 2, SR: 1 }),
      },
...

  {
    ...
    a: [
      ...
      {
        t: 'What people make together when they share what they have.',
        v: v({ CE: 3, UI: 1, WP: 1 }),
      },
...

  {
    ...
    a: [
      {
        t: 'Eat with them. Connection in this moment matters more than principle.',
        v: v({ CE: 3, ES: 1, PO: 1 }),
      },
...

  {
    ...
    a: [
      ...
      {
        t: 'It points beyond itself, toward something eternal.',
        v: v({ MR: 3, UI: 2, TD: 1, RT: 1 }),
      },
      { t: 'The highest form of usefulness — pleasure made permanent.', v: v({ ES: 3, VA: 2 }) },
      {
        t: "A reminder to stay alive to what's already here.",
        v: v({ PO: 2, ES: 2, MR: 1, VA: 1 }),
      },
    ],
  },
...

  {
    ...
    a: [
      {
        t: 'Argue, organize, vote. The system can be changed.',
        v: v({ WP: 2, CE: 2, UI: 1, VA: 1 }),
      },
      { t: 'Withdraw and live according to your own values.', v: v({ SS: 3, AT: 2, MR: 1 }) },
      {
        t: 'Wait. Quick change usually fails. Slow change endures.',
        v: v({ RT: 2, PO: 2, TR: 1 }),
      },
...

  {
    ...
    a: [
      {
        t: 'Yes. The body is hardware. The mind is what matters.',
        v: v({ SS: 2, TR: 1, WP: 2, SI: 2 }),
      },
      {
        t: "Yes, eventually. But not until we understand what we'd lose.",
        v: v({ SR: 2, TR: 1, PO: 2 }),
      },
      { t: "No. The body isn't separate from who I am.", v: v({ ES: 3, MR: 1, CE: 1 }) },
      { t: 'No. Death gives life its shape.', v: v({ TV: 3, MR: 1, AT: 2, VA: 1 }) },
      {
        t: 'The question assumes there\'s a "me" to upload. There isn\'t, in that sense.',
        v: v({ SI: 3, MR: 2, SR: 1 }),
      },
    ],
  },

  {
    ...
    a: [
      {
        t: 'Yes. We inherit their advantages, so we inherit their debts.',
        v: v({ CE: 2, UI: 3, RT: 1, WP: 1 }),
      },
      {
        t: 'Yes, in the sense that we should make things right going forward.',
        v: v({ WP: 2, PO: 2, UI: 1, CE: 1 }),
      },
      {
        t: 'No. Each person is responsible for what they did, not what we did.',
        v: v({ SS: 3, SR: 1, TR: 1 }),
      },
      {
        t: 'The question is more interesting than any answer to it.',
        v: v({ TD: 2, SR: 2, MR: 1 }),
      },
    ],
  },

  {
    ...
    a: [
      ...
      {
        t: 'Recognizing yourself in another person — the soul-meeting.',
        v: v({ MR: 2, CE: 2, UI: 1, SI: 1 }),
      },
      { t: 'The shared work of building a life together.', v: v({ CE: 3, PO: 2, WP: 1, RT: 1 }) },
      {
        t: 'An attention so complete it dissolves the boundary between you.',
        v: v({ MR: 3, ES: 2, SI: 2 }),
      },
      {
        t: 'A pattern with biological roots and built-up meaning. Both real, in different ways.',
        v: v({ SR: 2, TE: 2, SI: 1, TR: 1 }),
      },
    ],
  },
];
