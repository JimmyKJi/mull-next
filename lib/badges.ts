...
export const BADGES: Badge[] = [
  ...
  },
  {
    ...
    glyph: '↻',
    description:
      'Came back after a 30+ day silence and started writing again. The path widens after a pause.',
  ...
  },
  {
    ...
    glyph: '✺',
    description:
      'Reflected on at least one exercise in every category — contemplative, logic, and argument.',
  ...
  },
  {
    ...
    glyph: '◬',
    description:
      'Took the quiz at least three times. Watching how the map shifts is its own discipline.',
  ...
  },
  {
    ...
    glyph: '❋',
    description:
      'Made your profile public and shared at least one dilemma response. Joined the conversation.',
  ...
  },
  {
    ...
    glyph: '∾',
    description:
      'Wrote a hundred entries across all surfaces. The personal record is substantial now.',
  ...
  },
  {
    ...
    glyph: '✧',
    description:
      'Visited every one of the ten archetype pages. The full map of orientations seen, not just one.',
