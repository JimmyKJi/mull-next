...
export const PILGRIMAGE_ARCS: Record<string, PilgrimageArc> = {
  ...
  pilgrim: {
    ...
    days: [
      ...
      { day: 14, title: "Skepticism In Motion", framing: "Pilgrims are skeptical without being paralyzed — and they walk through storms they didn't choose, not because they should but because they couldn't not. The walking is the resolution.", prompt: "Name a claim you don't trust but can't refute, or a hard season you had no choice but to cross. How did you keep moving without the uncertainty stopping you?", expect: "Name what carried you — the technique, or whatever kept the walking going." },
