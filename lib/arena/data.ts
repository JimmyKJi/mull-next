...
export const ARENA_TOPICS: ArenaTopic[] = [
  ...
  // Everyday — practical dilemmas everyone has faced
  {
    ...
    prompt: "A friend has been draining and unreliable for two years. Is it okay to stop replying, or do you owe them a real conversation first?",
    primer: "The case for the conversation: they're a friend; the relationship deserves at least a goodbye. The case for ghosting: you've been the one carrying the relationship; the energy to draft the goodbye is the same energy you've been spending unwillingly already. Whose welfare gets weighed?",
  },
  {
    slug: "white-lie",
    category: "everyday",
    title: "The small lie",
    prompt: "Your partner shows you something they made and asks what you think. You think it's not very good. What do you say?",
    primer: "Honesty as principle, kindness as practice. Either alone fails; the interesting question is whether they're compatible, what you owe truth, and what you owe the person sitting across from you in the moment of asking.",
  },
  {
    slug: "career-vs-passion",
    category: "everyday",
    title: "The job vs the calling",
    prompt: "You have a job that pays well and is fine, and a passion that wouldn't pay rent. How much do you owe the passion?",
    primer: "The career advice industry says \"follow your passion\" or \"build skills first\" depending who's selling. The interesting question is how you'd justify either choice to your seventy-year-old self — and whether the seventy-year-old is a reliable judge.",
  },
  {
    slug: "social-media-honesty",
    category: "everyday",
    title: "Posting your real life",
    prompt: "Should you post the version of your life that's true, or the version that's encouraging to others?",
    primer: "Showing the curated version performs success and may inspire — but it also distorts reality for everyone scrolling. Showing the unedited version is honest, but may just be venting. There's a third option, harder to do, easier to defend.",
  },
  {
    slug: "skip-work",
    category: "everyday",
    title: "Calling in",
    prompt: "You're tired but not sick. Calling in lets you rest; not calling in keeps your integrity. What do you do?",
    primer: "Either you're an instrument of your job (and rest only when broken) or you're a person doing a job (and rest when you need it). Which framing is the dishonest one depends on something deeper than the choice itself.",
  },
  {
    slug: "splitting-bill",
    category: "everyday",
    title: "Splitting unevenly",
    prompt: "Your group ordered. You had water and a small salad; everyone else had drinks and entrées. The waiter brings one bill. How do you handle it?",
    primer: "Splitting equally is socially smoother and may build the relationship. Asking to itemize is fair and may build the principle. Which moves matter more depends on how often you eat with these people and what you owe them beyond the meal.",
  },
  {
    slug: "old-friend-views",
    category: "everyday",
    title: "When an old friend changes",
    prompt: "A friend of fifteen years has developed political views you find genuinely harmful. The friendship is real. What do you do?",
    primer: "Cut them off and you preserve your principles at the cost of the human; stay friends and you preserve the human at the possible cost of complicity. Confront them and risk both. The cleanest answer probably isn't available.",
  },
  {
    slug: "settle-down",
    category: "everyday",
